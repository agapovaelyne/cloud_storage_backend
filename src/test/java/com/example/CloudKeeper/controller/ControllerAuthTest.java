...
public class ControllerAuthTest {
    ...
    @Test
    void login_test() {
        ResponseEntity<AuthorizationTokenDTO> actual = cloudController.login(testModels.getAuthRequest());
    ...
    void login_failed_test() {
        ResponseEntity<AuthorizationTokenDTO> actual = cloudController.login(testModels.getBadAuthRequest());
    ...
    @Test
    void logout_test() {
        HttpStatus actual = cloudController.logout(testModels.getAuthToken());
